...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[354], {
    ...
    32: (e, t, n) => {
        ...
        class NestedAccordion extends r.default {
            ...
            linkContainer(e) {
                const {container: t, index: n, targetContainer: i, action: {type: r}} = e.detail
                  , s = t.view.$el;
            ...
            updateIndexValues() {
                ...
                t.each(( (t, r) => {
                    ...
                    r.querySelector(n.selectors.accordionItemTitles).setAttribute(n.attributes.index, t + 1),
                    r.querySelector(n.selectors.accordionItemTitles).setAttribute("aria-controls", `${i}${t}`),
                    r.querySelector(n.selectors.accordionItemTitlesText).setAttribute("data-binding-index", t + 1),
            ...
            clickListener(e) {
                ...
                n.open ? this.closeAccordionItem(n, r) : this.prepareOpenAnimation(n, r, s)
            }
            animateItem(e, t, n, i) {
    ...
    7323: (e, t, n) => {
        ...
        class NestedTabs extends r.default {
            ...
            linkContainer(e) {
                ...
                t.model.get("id") === this.$element.data("id") && (this.updateIndexValues(),
            ...
            updateIndexValues() {
                ...
                t.each(( (t, s) => {
                    ...
                    s.querySelector(n.selectors.tabTitleText).setAttribute("data-binding-index", o),
                    s.querySelector(n.selectors.tabTitleText).setAttribute("aria-controls", a),
